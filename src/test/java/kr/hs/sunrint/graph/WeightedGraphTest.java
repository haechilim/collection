...
public class WeightedGraphTest {
    ...
    public void 노드_추가() {
        ...
        assertEquals("8 15", getDataWeightList((WeightedNode<String>) weightedGraph.searchNodeByData("0")));
        assertEquals("8 17 10", getDataWeightList((WeightedNode<String>) weightedGraph.searchNodeByData("1")));
        assertEquals("17 27", getDataWeightList((WeightedNode<String>) weightedGraph.searchNodeByData("2")));
        assertEquals("27 29 25", getDataWeightList((WeightedNode<String>) weightedGraph.searchNodeByData("3")));
        assertEquals("29 21 23", getDataWeightList((WeightedNode<String>) weightedGraph.searchNodeByData("4")));
        assertEquals("15 21", getDataWeightList((WeightedNode<String>) weightedGraph.searchNodeByData("5")));
        assertEquals("10 25 23", getDataWeightList((WeightedNode<String>) weightedGraph.searchNodeByData("6")));
    }
    ...
    public void 노드_삭제() {
        ...
        assertEquals("8 17 10", getDataWeightList((WeightedNode<String>) weightedGraph.searchNodeByData("1")));
        assertEquals("17 27", getDataWeightList((WeightedNode<String>) weightedGraph.searchNodeByData("2")));
        assertEquals("27 25", getDataWeightList((WeightedNode<String>) weightedGraph.searchNodeByData("3")));
        assertEquals("15", getDataWeightList((WeightedNode<String>) weightedGraph.searchNodeByData("5")));
        assertEquals("10 25", getDataWeightList((WeightedNode<String>) weightedGraph.searchNodeByData("6")));
    }
    ...
    private String getDataWeightList(WeightedNode<String> node) {
        String result = "";
