...
public class BinarySearchTreeTest {
    ...
    public void leaf_노드_삭제() {
        ...
        assertEquals("50 30 70 35 60 80 34 65", binarySearchTree.getTraversalNodes());

        binarySearchTree.removeNode(80);
        binarySearchTree.traverseLevel();
        assertEquals("50 30 70 35 60 34 65", binarySearchTree.getTraversalNodes());
    }
    ...
    public void 자식_노드가_왼쪽_1개인_노드_삭제() {
        ...
        binarySearchTree.traverseLevel();
        assertEquals("50 30 70 1 34 60 80 65", binarySearchTree.getTraversalNodes());
    }
    ...
    public void 자식_노드가_오른쪽_1개인_노드_삭제() {
        ...
        binarySearchTree.traverseLevel();
        assertEquals("50 30 70 1 35 65 80 34", binarySearchTree.getTraversalNodes());
    }
    ...
    public void 자식_노드가_왼쪽_1개인_루트노드_삭제() {
        ...
        tree.removeNode(50);
        tree.traverseLevel();
        assertEquals("35", tree.getTraversalNodes());
    }
    ...
    public void 자식_노드가_오른쪽_1개인_루트노드_삭제() {
        ...
        tree.removeNode(50);
        tree.traverseLevel();
        assertEquals("70", tree.getTraversalNodes());
    }
    ...
    public void 자식_노드가_2개인_노드_삭제() {
        ...
        binarySearchTree.traverseLevel();
        assertEquals("50 30 80 1 35 60 34 65", binarySearchTree.getTraversalNodes());
    }
    ...
    public void 자식_노드가_2개인_루트_노드_삭제() {
        ...
        binarySearchTree.traverseLevel();
        assertEquals("60 30 70 1 35 65 80 34", binarySearchTree.getTraversalNodes());
    }
}
